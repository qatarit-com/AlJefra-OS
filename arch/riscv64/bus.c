...
/* QEMU virt 32-bit PCIe MMIO window: 0x40000000 - 0x7FFFFFFF.
 * When booting with -kernel (no firmware), BARs are unassigned.
 * We assign them here from the MMIO window. */
#define PCIE_MMIO_BASE    0x40000000ULL
#define PCIE_MMIO_END     0x80000000ULL
