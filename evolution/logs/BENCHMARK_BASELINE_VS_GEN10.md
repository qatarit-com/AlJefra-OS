...
| Metric | BASELINE | GEN10 | Delta | Change |
|--------|-------------|---------------|-------|--------|
| **Binary size** (bytes) | 20480 | 20480 | 0 | 0.0% |
| **Total instructions** | 4155 | 4774 | +619 | 14.9% |
| **Code bytes** | 10770 | 12766 | +1996 | 18.5% |
| **Code density** (B/instr) | 2.592 | 2.674 | — | — |
...
| Pattern | Description | BASELINE | GEN10 | Delta |
|---------|-------------|-------------|---------------|-------|
| `test` | Zero-comparison (efficient) | 15 | 71 | +56 |
| `cmp *, 0` | Zero-comparison (replaced by test) | 18 | 7 | -11 |
| `lea` | Address calc (replaces shl+add) | 1 | 13 | +12 |
| `pause` | Spin-wait hint | 0 | 10 | +10 |
| `bt/bts/btr` | Bit-test operations | 43 | 45 | +2 |
| `imul` | Signed multiply (no EDX clobber) | 0 | 19 | +19 |
| `mul` | Unsigned multiply (EDX clobbered) | 23 | 8 | -15 |
| `movzx` | Zero-extending loads | 0 | 21 | +21 |
| `call os_apic_*` | APIC calls (inlined in Gen-10) | 17 | 2 | -15 |
| `prefetchnta` | Cache prefetch hints | 0 | 13 | +13 |
| `rep stosq` | 64-bit memory fill | 1 | 7 | +6 |
| `xchg` | Implicit LOCK exchange | 13 | 12 | -1 |
...
|-----------|-----------|-------------|-----|-----|-----------|-------------|-----|-----|
| `kernel.asm` | 76 | 75 | -1 | -1.3% | 267 | 281 | +14 | 5.2% |
| `init.asm` | 0 | 0 | 0 | N/A | 0 | 0 | 0 | N/A |
| `init/64.asm` | 129 | 138 | +9 | 7.0% | 519 | 542 | +23 | 4.4% |
| `init/bus.asm` | 70 | 70 | 0 | 0.0% | 226 | 217 | -9 | -4.0% |
| `init/hid.asm` | 4 | 4 | 0 | 0.0% | 16 | 16 | 0 | 0.0% |
| `init/net.asm` | 52 | 57 | +5 | 9.6% | 196 | 217 | +21 | 10.7% |
| `init/nvs.asm` | 21 | 22 | +1 | 4.8% | 78 | 82 | +4 | 5.1% |
| `init/sys.asm` | 12 | 12 | 0 | 0.0% | 58 | 58 | 0 | 0.0% |
| `syscalls.asm` | 0 | 0 | 0 | N/A | 0 | 0 | 0 | N/A |
| `syscalls/bus.asm` | 96 | 91 | -5 | -5.2% | 253 | 252 | -1 | -0.4% |
| `syscalls/debug.asm` | 160 | 159 | -1 | -0.6% | 452 | 469 | +17 | 3.8% |
| `syscalls/io.asm` | 27 | 26 | -1 | -3.7% | 67 | 65 | -2 | -3.0% |
| `syscalls/net.asm` | 81 | 80 | -1 | -1.2% | 231 | 230 | -1 | -0.4% |
| `syscalls/nvs.asm` | 43 | 45 | +2 | 4.7% | 113 | 117 | +4 | 3.5% |
| `syscalls/smp.asm` | 147 | 168 | +21 | 14.3% | 383 | 453 | +70 | 18.3% |
| `syscalls/system.asm` | 126 | 107 | -19 | -15.1% | 399 | 371 | -28 | -7.0% |
| `drivers.asm` | 0 | 0 | 0 | N/A | 0 | 0 | 0 | N/A |
| `drivers/apic.asm` | 12 | 22 | +10 | 83.3% | 43 | 67 | +24 | 55.8% |
| `drivers/ioapic.asm` | 52 | 54 | +2 | 3.8% | 143 | 147 | +4 | 2.8% |
| `drivers/msi.asm` | 107 | 107 | 0 | 0.0% | 272 | 265 | -7 | -2.6% |
| `drivers/ps2.asm` | 137 | 140 | +3 | 2.2% | 522 | 519 | -3 | -0.6% |
| `drivers/serial.asm` | 47 | 46 | -1 | -2.1% | 123 | 121 | -2 | -1.6% |
| `drivers/timer.asm` | 158 | 159 | +1 | 0.6% | 478 | 479 | +1 | 0.2% |
| `drivers/virtio.asm` | 0 | 0 | 0 | N/A | 0 | 0 | 0 | N/A |
| `drivers/bus/pci.asm` | 26 | 26 | 0 | 0.0% | 63 | 63 | 0 | 0.0% |
| `drivers/bus/pcie.asm` | 41 | 40 | -1 | -2.4% | 102 | 101 | -1 | -1.0% |
| `drivers/nvs/virtio-blk.asm` | 237 | 230 | -7 | -3.0% | 729 | 702 | -27 | -3.7% |
| `drivers/net/virtio-net.asm` | 393 | 378 | -15 | -3.8% | 1207 | 1165 | -42 | -3.5% |
| `drivers/lfb/lfb.asm` | 18 | 18 | 0 | 0.0% | 72 | 72 | 0 | 0.0% |
| `interrupt.asm` | 309 | 344 | +35 | 11.3% | 1078 | 1226 | +148 | 13.7% |
| `sysvar.asm` | 17 | 17 | 0 | 0.0% | 95 | 105 | +10 | 10.5% |
| **TOTAL** | **2598** | **2635** | **+37** | **1.4%** | **8185** | **8402** | **+217** | **2.7%** |
...
|----------|-----------|-------------|-----|-----|-------------|----------------|--------|-----|
| `ap_clear` | 13 | 10 | -3 | -23.1% | 43 | 40 | -3 | -7.0% |
| `b_smp_lock` | 5 | 7 | +2 | 40.0% | 16 | 18 | +2 | 12.5% |
| `b_smp_unlock` | 2 | 2 | 0 | 0.0% | 6 | 4 | -2 | -33.3% |
| `ap_wakeup` | 9 | 7 | -2 | -22.2% | 21 | 25 | +4 | 19.0% |
| `b_smp_wakeup` | 36 | 33 | -3 | -8.3% | 104 | 102 | -2 | -1.9% |
| `b_smp_get_id` | 6 | 4 | -2 | -33.3% | 17 | 15 | -2 | -11.8% |
| `b_smp_wakeup_all` | 17 | 16 | -1 | -5.9% | 50 | 50 | 0 | 0.0% |
| `b_smp_reset` | 19 | 17 | -2 | -10.5% | 54 | 52 | -2 | -3.7% |
| `lfb_draw_line` | 41 | 32 | -9 | -22.0% | 165 | 144 | -21 | -12.7% |
...
**Cumulative from baseline (fd5a707):** 4155 instructions, 10770 code bytes
**Current (aa7fe4d):** 4774 instructions, 12766 code bytes
**Net reduction:** +619 instructions (14.9%), +1996 code bytes (18.5%)
