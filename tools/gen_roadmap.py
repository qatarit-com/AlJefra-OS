...
<head>
    ...
    <meta name="description" content="AlJefra OS v0.7.4 Roadmap - The first Qatari operating system. AI chat, desktop GUI, driver marketplace, secure boot, 3-architecture support.">
...
<body>
    ...
    <section class="page-header">
        <h1>v0.7.4 Production Roadmap</h1>
        <p>""" + esc(status_note) + """</p>
    </section>""")
    ...
    <section class="section">
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1rem; margin: 1.5rem 0;">
            ...
            <div style="background: var(--bg-secondary); border: 1px solid {green}; border-radius: 8px; padding: 1.25rem; text-align: center;">
                ...
                <div style="color: var(--text-secondary); font-size: 0.85rem;">v0.7.4 Complete</div>
            </div>
        </div>
    </section>""")
    ...
    lines.append("""
    <footer>
        <p>&copy; 2026 AlJefra OS v0.7.4 | The First Qatari Operating System | <a href="https://os.aljefra.com">os.aljefra.com</a></p>
